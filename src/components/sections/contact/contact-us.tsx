...
export default function ContactUs() {
    return (
        <section id="countactUs" className="md:my-10 md:mx-30 my-5 mx-5">
            <Title brand='MinKits Team' title='Contact Us' subTitle='Contact Us'/>
            <div className="relative flex flex-col md:flex-row justify-center">
                ...
                <div className="basis-1/2 relative flex flex-col">
                    <div className="flex items-center justify-center px-10 basis-2/5">
                        <Image src={'/images/logo/logo-f-b.png'} alt={'logo'} height={400} width={400}/>
                    </div>
                    <div className="flex flex-col items-center justify-center px-10 basis-1/4">
                        <div
                            className='w-full h-px mt-8 bg-linear-to-r from-white/25 via-black to-white/25'></div>
