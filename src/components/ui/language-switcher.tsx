...
export default function LanguageSwitcher() {
    ...
    const active = useMemo<Language | null>(() => {
        if (!pathname) return null;
        const locale = pathname.split("/")[1];
        return LANGUAGES.find((l) => l.code === locale) ?? null;
    }, [pathname]);
    ...
    return (
        <div ref={wrapperRef} className="relative inline-flex lang">
            {/* Trigger */}
            <button
                type="button"
                aria-haspopup="menu"
            ...
            <div
                role="menu"
                className={clsx(
                    "absolute right-0 mt-2 w-30 rounded-lg bg-white p-1 shadow-lg text-black",
                    "dark:bg-neutral-800",
                    open
                ...
                {LANGUAGES.map((lang) => (
                    <button
                        ...
                        className={clsx(
                            ...
                            "hover:bg-zinc-100 dark:hover:bg-neutral-700",
                            active?.code === lang.code &&
                            "bg-zinc-100 dark:bg-neutral-700 font-medium"
                        )}
                    >
                        {lang.flag}
                        {lang.label}
