    ...
    return (
        <section className="relative bg-[var(--color-primary)]">
            <div className="relative w-full">
                <div className="stage h-[clamp(560px,100svh,900px)]">
                    ...
                    <svg style={{
                        ...
                        <g className="cluster c1" transform="translate(180 410)">
                            <circle r="26" fill="none" stroke="rgba(232,188,98,.55)" strokeWidth="1"
                                    strokeDasharray="2 6"/>
                        ...
                        <g className="cluster c2" transform="translate(435 350)">
                            <circle r="25" fill="none" stroke="rgba(232,188,98,.55)" strokeWidth="1"
                                    strokeDasharray="2 6"/>
                            <circle r="5" fill="#F7F3EA" filter="url(#tinyGlow)"/>
                        ...
                        <g className="cluster c3" transform="translate(710 308)">
                            <circle r="28" fill="none" stroke="rgba(232,188,98,.55)" strokeWidth="1"
                                    strokeDasharray="2 6"/>
                            <circle r="5" fill="#F7F3EA" filter="url(#tinyGlow)"/>
                ...
                <div className="relative z-20 -mt-10 w-full px-4 pb-6 sm:absolute sm:bottom-6 sm:left-1/2 sm:mt-0 sm:-translate-x-1/2 sm:px-5 sm:pb-0">
                    <div
                        className="
        mx-auto
        grid
    ...
    "
                    >
                        {items.map((item, index) => {
                            ...
                            return (
                                <HeroFooterCard key={index} className={"h-full cursor-default py-5 text-center sm:py-4 md:py-5"}>
